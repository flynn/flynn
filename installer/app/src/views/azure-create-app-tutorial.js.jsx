...
var AzureCreateAppTutorial = React.createClass({
    ...
    render: function () {
        ...
        if (state.tutorialSlide !== null || state.skipTutorial) {
            pagination.prev = (state.skipTutorial && state.tutorialSlide !== null) ? <button id="azureTutPrev" onClick={this.__skipTutorial}>Back</button> : '';
            pagination.prev = (state.tutorialSlide > 0) ? <button id="azureTutPrev" onClick={this.__handleGoBackTutorialClick}>Back</button> : pagination.prev;
            pagination.next = (state.tutorialSlide < 8) ? <button id="azureTutNext" onClick={this.__handleAdvanceTutorialClick}>Next</button> : '';
