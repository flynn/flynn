...
var GithubCommits = FlynnDashboard.Stores.GithubCommits = FlynnDashboard.Store.createClass({
	...
	__fetchCommits: function (options) {
		...
		var client = FlynnDashboard.githubClient;
		var pages = [];
...
GithubCommits.prototype.__rewriteJSON = FlynnDashboard.Stores.GithubCommit.prototype.__rewriteJSON;
