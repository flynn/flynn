...
INSERT INTO static_certificates (id, chain, key_id, strict)
VALUES ($1, $2, $3, $4)
...
VALUES ($1, $2)`
	tlsKeyListQuery = `
SELECT k.id, k.algorithm, k.key, ARRAY(SELECT id FROM static_certificates WHERE key_id = k.id), k.created_at FROM tls_keys AS k
