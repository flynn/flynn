...
func appHandler(c handlerConfig) http.Handler {
	...
	httpRouter.GET("/providers/:providers_id/resources/:resources_id/tunables", httphelper.WrapHandler(api.GetResourceTunables))
	httpRouter.POST("/providers/:providers_id/resources/:resources_id/tunables", httphelper.WrapHandler(api.PostResourceTunables))
