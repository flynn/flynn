...
var AppEnvActions = FlynnDashboard.Actions.AppEnv;
...
FlynnDashboard.Views.AppEnv = React.createClass({
		...
		return (
			<Modal onShow={function(){}} onHide={this.props.onHide} visible={true}>
				<section className="app-env">
					...
					{env ? (
						<div>
							<FlynnDashboard.Views.EditEnv env={env} onChange={this.__handleEnvChange} />
